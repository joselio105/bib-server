...
interface Model
{
    ...
    public function findMany(string $whereClauses, array $values, array $fields = []): array;
    public function findOne(string $whereClauses, array $values, array $fields = []): Entity;
